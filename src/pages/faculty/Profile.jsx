...
const ProfileInputField = ({ label, value, name, type = 'text', onChange, placeholder = '', readOnly = true }) => (
  <div className="mb-4">
    ...
    <input
      ...
      className={`mt-1 block w-full px-3 py-2 border ${readOnly ? 'bg-gray-100' : 'bg-white'} border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
    />
  </div>
);
...
const FacultyProfile = () => {
  ...
  const handleSubmitPasswordChange = () => {
    ...
    setTimeout(() => {
      if (currentPassword === 'correctPassword123') { // Mock validation
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-2xl w-full mx-auto my-8">
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
            ...
            <BasicInfoRow label="Birthday" value={profile.dateOfBirth} type="date" />
