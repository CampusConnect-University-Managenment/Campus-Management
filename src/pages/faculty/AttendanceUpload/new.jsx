...
//     batch: "2021-2025",
//     department: "CSE",
//     enrolledCourses: ["CS202", "CS204", "GE101"],
//   },
//   {
//     id: "21CS002",
//     name: "Rohan Gupta",
...
//     () => masterTimetable.filter((c) => c.day === dayOfWeek),
//     [dayOfWeek]
//   );
//   const availableBatches = useMemo(
//     () => getUniqueValues(classesOnSelectedDay, "batch"),
...
//     () => getUniqueObjects(classesForSelectedBatch, "courseCode"),
//     [classesForSelectedBatch]
//   );
...
//       if (
//         lastBlock &&
//         currentHour.hour === lastBlock[lastBlock.length - 1].hour + 1
//       ) {
...
//     setFilters({ date: new Date(e.target.value), batch: "", courseCode: "" });
//   const handleBatchChange = (e) =>
//     setFilters((prev) => ({ ...prev, batch: e.target.value, courseCode: "" }));
...
//     setSelectedClasses(
//       masterTimetable.filter((c) => selectedHourIds.includes(c.id))
//     );
//     setStep(3);
//   };
...
//     const recordsForBatch = history.filter(
//       (rec) =>
//         rec.date === toYYYYMMDD(filters.date) && rec.batch === filters.batch
//     );
//     return getUniqueObjects(recordsForBatch, "courseCode");
...
//     link.setAttribute(
//       "download",
//       `attendance_history_${toYYYYMMDD(new Date())}.csv`
//     );
...
//           <button
//             onClick={downloadCSV}
//             disabled={!showData || filteredHistory.length === 0}
//             className="px-4 py-2 font-semibold text-white bg-green-600 rounded-md shadow-sm hover:bg-green-700 disabled:bg-green-300"
//           >
...
//         </table>
//       </div>
//       {showData && filteredHistory.length > recordsPerPage && (
