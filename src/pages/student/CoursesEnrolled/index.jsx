...
//     const updated = { ...uploadedAssignments };
//     if (!updated[courseId]) updated[courseId] = {};
//     updated[courseId][index] = file;
//     setUploadedAssignments(updated);
//   };

//   const handleRemoveFile = (courseId, index) => {
//     const updated = { ...uploadedAssignments };
//     if (updated[courseId]) delete updated[courseId][index];
//     setUploadedAssignments(updated);
//   };

//   const handleSubmit = (courseId, index) => {
//     const file = uploadedAssignments[courseId]?.[index];
//     if (!file) return;
...
//                 const uploadedFile = uploadedAssignments[selectedCourse.id]?.[index];
//                 return (
...
//                       {uploadedFile && (
//                         <button
//                           onClick={() => handleRemoveFile(selectedCourse.id, index)}
...
//                         className={`px-4 py-2 rounded text-white ${uploadedFile ? "bg-green-600 hover:bg-green-700" : "bg-gray-400 cursor-not-allowed"}`}
//                       >
//                         Submit
//                       </button>
//                     </div>

//                     {uploadedFile && <p className="text-green-600 text-sm mt-2">✅ Selected: {uploadedFile.name}</p>}
//                   </li>
//                 );
//               })}
//             </ul>
