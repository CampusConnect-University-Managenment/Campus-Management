...
//                   <div className="bg-gray-50 p-3 rounded-lg">
//                     <p className="text-sm text-gray-500 font-medium">First Year</p>
//                     <p className="text-lg font-bold text-gray-700">
//                       {dept.yearDistribution.first}
//                     </p>
//                   </div>
//                   <div className="bg-gray-50 p-3 rounded-lg">
//                     <p className="text-sm text-gray-500 font-medium">Second Year</p>
//                     <p className="text-lg font-bold text-gray-700">
//                       {dept.yearDistribution.second}
//                     </p>
//                   </div>
//                   <div className="bg-gray-50 p-3 rounded-lg">
//                     <p className="text-sm text-gray-500 font-medium">Third Year</p>
//                     <p className="text-lg font-bold text-gray-700">
//                       {dept.yearDistribution.third}
//                     </p>
//                   </div>
//                   <div className="bg-gray-50 p-3 rounded-lg">
//                     <p className="text-sm text-gray-500 font-medium">Fourth Year</p>
//                     <p className="text-lg font-bold text-gray-700">
