      ...
      <div className="p-6 bg-gray-50 min-h-screen">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg mt-1 font-medium">
            Welcome back to your campus dashboard. Here's what's happening
            today.
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-lg p-4 shadow-sm border hover:bg-blue-600 hover:text-white transition cursor-pointer">
                ...
                <p className="font-medium">
                  <span className="font-bold">Duration:</span> 8/1/2025 -
                  15/1/2025
                </p>
                <p className="font-medium">
                  <span className="font-bold">Reason:</span> Medical Leave
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm border hover:bg-blue-600 hover:text-white transition cursor-pointer">
                ...
                <p className="font-medium">
                  <span className="font-bold">Duration:</span> 10/1/2025 -
                  12/1/2025
                </p>
                <p className="font-medium">
                  <span className="font-bold">Reason:</span> Conference
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm border hover:bg-blue-600 hover:text-white transition cursor-pointer">
                ...
                <p className="font-medium">
                  <span className="font-bold">Duration:</span> 9/1/2025 -
                  16/1/2025
                </p>
                <p className="font-medium">
                  <span className="font-bold">Reason:</span> Annual Leave
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm border hover:bg-blue-600 hover:text-white transition cursor-pointer">
                ...
                <p className="font-medium">
                  <span className="font-bold">Duration:</span> 11/1/2025 -
                  13/1/2025
                </p>
                <p className="font-medium">
                  <span className="font-bold">Reason:</span> Personal
                </p>
              </div>
            </div>
          </div>
